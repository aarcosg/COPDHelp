...
public class MedicalAttentionStackedBarChartItem extends StackedBarChartItem {
    ...
    public MedicalAttentionStackedBarChartItem(int type, String header, String progressLabel, Double changePercentage, List<String> xVals, List<BarEntry> yVals, int[] dataSetColors, String[] stackLabels, boolean drawValues) {
